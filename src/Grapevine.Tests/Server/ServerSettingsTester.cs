...
{
    public class ServerSettingsTester
    {
        [Fact]
        public void server_settings_default_configuration()
        {
        ...
        [Fact]
        public void server_settings_on_start_is_synonym_for_on_after_start()
        {
            var options = new ServerSettings();
        ...
        [Fact]
        public void server_settings_on_stop_is_synonym_for_on_after_stop()
        {
            var options = new ServerSettings();
